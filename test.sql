...
CREATE DATABASE qlsv CHARACTER
SET
...
CREATE TABLE
    Grades (
        ...
        maLHP INT NOT NULL,
        diem1 DECIMAL(4, 2) CHECK (diem1 BETWEEN 0 AND 10),
        diem2 DECIMAL(4, 2) CHECK (diem2 BETWEEN 0 AND 10),
...
INSERT INTO
    `rooms` (`room_name`, `capacity`, `room_type`)
VALUES
    ('A1-101', 80, 'Lý thuyết'),
    ('A1-102', 80, 'Lý thuyết'),
...
ALTER TABLE `class_schedules` ADD INDEX `idx_time_check` (`day_of_week`, `start_period`, `num_periods`),
...
VALUES
    (1, 1, 2, 1, 3, '2023-09-05', '2024-01-15'),
...
VALUES
    (2, 2, 3, '2025-01-16', '2025-05-30', 15, 1);
...
VALUES
    (2, 1, 3, '2023-09-05', '2024-01-15', 8, 1);
...
('sv17', N'Nguyễn Văn An', N'Nam', 2005, N'Hà Nội', 'an.nv@gmail.com', '0912345617', 'LH12'),
('sv18', N'Trần Thị Bình', N'Nữ', 2005, N'Hải Phòng', 'binh.tt@gmail.com', '0912345618', 'LH12'),
('sv19', N'Lê Hoàng Cường', N'Nam', 2005, N'Đà Nẵng', 'cuong.lh@gmail.com', '0912345619', 'LH12'),
('sv20', N'Phạm Hồng Dung', N'Nữ', 2005, N'TP HCM', 'dung.ph@gmail.com', '0912345620', 'LH12'),
('sv21', N'Hoàng Minh Đức', N'Nam', 2005, N'Cần Thơ', 'duc.hm@gmail.com', '0912345621', 'LH12'),
('sv22', N'Vũ Thị Hoa', N'Nữ', 2005, N'Quảng Ninh', 'hoa.vt@gmail.com', '0912345622', 'LH12'),
('sv23', N'Phan Văn Hùng', N'Nam', 2005, N'Nghệ An', 'hung.pv@gmail.com', '0912345623', 'LH12'),
('sv24', N'Đỗ Thu Hà', N'Nữ', 2005, N'Thanh Hóa', 'ha.dt@gmail.com', '0912345624', 'LH12'),
('sv25', N'Bùi Quang Hải', N'Nam', 2005, N'Hải Dương', 'hai.bq@gmail.com', '0912345625', 'LH12'),
('sv26', N'Đặng Thị Khánh', N'Nữ', 2005, N'Bắc Ninh', 'khanh.dt@gmail.com', '0912345626', 'LH12'),
('sv27', N'Ngô Tiến Long', N'Nam', 2005, N'Thừa Thiên Huế', 'long.nt@gmail.com', '0912345627', 'LH12'),
('sv28', N'Dương Thúy Minh', N'Nữ', 2005, N'Quảng Nam', 'minh.dt@gmail.com', '0912345628', 'LH12'),
('sv29', N'Lý Văn Nam', N'Nam', 2005, N'Khánh Hòa', 'nam.lv@gmail.com', '0912345629', 'LH12'),
('sv30', N'Trịnh Thị Nhung', N'Nữ', 2005, N'Bình Dương', 'nhung.tt@gmail.com', '0912345630', 'LH12'),
('sv31', N'Đoàn Văn Phong', N'Nam', 2005, N'Đồng Nai', 'phong.dv@gmail.com', '0912345631', 'LH12'),
('sv32', N'Đinh Thị Quỳnh', N'Nữ', 2005, N'Long An', 'quynh.dt@gmail.com', '0912345632', 'LH12'),
('sv33', N'Lâm Minh Quân', N'Nam', 2005, N'Tiền Giang', 'quan.lm@gmail.com', '0912345633', 'LH12'),
('sv34', N'Phùng Bảo Ngọc', N'Nữ', 2005, N'Vĩnh Long', 'ngoc.pb@gmail.com', '0912345634', 'LH12'),
('sv35', N'Tống Văn Sơn', N'Nam', 2005, N'Cà Mau', 'son.tv@gmail.com', '0912345635', 'LH12'),
('sv36', N'Trương Mai Trang', N'Nữ', 2005, N'Vũng Tàu', 'trang.tm@gmail.com', '0912345636', 'LH12'),
('sv37', N'Mai Xuân Trường', N'Nam', 2005, N'Nam Định', 'truong.mx@gmail.com', '0912345637', 'LH12'),
('sv38', N'Hồ Thị Tuyết', N'Nữ', 2005, N'Thái Bình', 'tuyet.ht@gmail.com', '0912345638', 'LH12'),
('sv39', N'Cao Văn Tuấn', N'Nam', 2005, N'Ninh Bình', 'tuan.cv@gmail.com', '0912345639', 'LH12'),
('sv40', N'Diệp Thảo Uyên', N'Nữ', 2005, N'Hà Nam', 'uyen.dt@gmail.com', '0912345640', 'LH12'),
('sv41', N'Đỗ Hoàng Việt', N'Nam', 2005, N'Hưng Yên', 'viet.dh@gmail.com', '0912345641', 'LH12'),
('sv42', N'Vũ Hải Yến', N'Nữ', 2005, N'Vĩnh Phúc', 'yen.vh@gmail.com', '0912345642', 'LH12'),
('sv43', N'Nguyễn Đình Anh', N'Nam', 2005, N'Phú Thọ', 'anh.nd@gmail.com', '0912345643', 'LH12'),
('sv44', N'Trần Huyền Châu', N'Nữ', 2005, N'Bắc Giang', 'chau.th@gmail.com', '0912345644', 'LH12'),
('sv45', N'Lê Quốc Duy', N'Nam', 2005, N'Lạng Sơn', 'duy.lq@gmail.com', '0912345645', 'LH12'),
('sv46', N'Phạm Thu Giang', N'Nữ', 2005, N'Sơn La', 'giang.pt@gmail.com', '0912345646', 'LH12'),
('sv47', N'Hoàng Gia Huy', N'Nam', 2005, N'Lào Cai', 'huy.hg@gmail.com', '0912345647', 'LH12'),
('sv48', N'Vũ Minh Khuê', N'Nữ', 2005, N'Yên Bái', 'khue.vm@gmail.com', '0912345648', 'LH12'),
('sv49', N'Phan Thanh Liêm', N'Nam', 2005, N'Hòa Bình', 'liem.pt@gmail.com', '0912345649', 'LH12'),
('sv50', N'Đỗ Khánh Linh', N'Nữ', 2005, N'Thái Nguyên', 'linh.dk@gmail.com', '0912345650', 'LH12'),
('sv51', N'Bùi Đức Mạnh', N'Nam', 2005, N'Tuyên Quang', 'manh.bd@gmail.com', '0912345651', 'LH12'),
('sv52', N'Đặng Hồng Nga', N'Nữ', 2005, N'Cao Bằng', 'nga.dh@gmail.com', '0912345652', 'LH12'),
('sv53', N'Ngô Chí Phát', N'Nam', 2005, N'Hà Giang', 'phat.nc@gmail.com', '0912345653', 'LH12'),
('sv54', N'Dương Minh Phương', N'Nữ', 2005, N'Lai Châu', 'phuong.dm@gmail.com', '0912345654', 'LH12'),
('sv55', N'Lý Thành Tâm', N'Nam', 2005, N'Điện Biên', 'tam.lt@gmail.com', '0912345655', 'LH12'),
('sv56', N'Trịnh Diệp Thảo', N'Nữ', 2005, N'Gia Lai', 'thao.td@gmail.com', '0912345656', 'LH12'),
('sv57', N'Đoàn Anh Tú', N'Nam', 2005, N'Đắk Lắk', 'tu.da@gmail.com', '0912345657', 'LH12'),
('sv58', N'Đinh Cẩm Vân', N'Nữ', 2005, N'Lâm Đồng', 'van.dc@gmail.com', '0912345658', 'LH12'),
('sv59', N'Lâm Quốc Vũ', N'Nam', 2005, N'Bình Phước', 'vu.lq@gmail.com', '0912345659', 'LH12'),
('sv60', N'Phùng Kim Xuân', N'Nữ', 2005, N'Tây Ninh', 'xuan.pk@gmail.com', '0912345660', 'LH12');