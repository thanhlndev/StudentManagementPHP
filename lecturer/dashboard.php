...
$stats['lop']->execute([$maGV]);
$lopCount = $stats['lop']->fetchColumn();
$stats['sv']->execute([$maGV]);
$svCount = $stats['sv']->fetchColumn();
$stats['chua_khoa']->execute([$maGV]);
$chuaKhoa = $stats['chua_khoa']->fetchColumn();
        ...
        <div class="card border-left-info shadow h-100 py-2">
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col">
                        <div class="text-xs font-weight-bold text-info text-uppercase">Số lớp phụ trách</div>
                        <div class="h5 font-weight-bold"><?= $lopCount ?> lớp</div>
                    </div>
    ...
    <div class="col-xl-4 mb-4">
        <div class="card border-left-primary shadow h-100 py-2">
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col">
                        <div class="text-xs font-weight-bold text-primary text-uppercase">Tổng sinh viên</div>
                        <div class="h5 font-weight-bold"><?= $svCount ?> SV</div>
                    </div>
    ...
    <div class="col-xl-4 mb-4">
        <div class="card border-left-warning shadow h-100 py-2">
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col">
                        <div class="text-xs font-weight-bold text-warning text-uppercase">Lớp chưa chốt điểm</div>
                        <div class="h5 font-weight-bold"><?= $chuaKhoa ?> lớp</div>
                    </div>
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-info">Danh sách lớp học phần</h6>
    </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="index.php?page=grade_detail&maLHP=<?= $c['maLHP'] ?>"
                                class="btn btn-sm btn-<?= $c['isLocked'] ? 'secondary' : 'primary' ?>">
