<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item <?= ($page == 'courses') ? 'active' : '' ?>"><a class="nav-link"
            href="index.php?page=courses"><i class="fas fa-fw fa-book"></i><span>Môn học phần</span></a></li>
    <li class="nav-item <?= ($page == 'classes') ? 'active' : '' ?>"><a class="nav-link"
            href="index.php?page=classes"><i class="fas fa-fw fa-users"></i><span>Lớp chính quy</span></a></li>
    <li class="nav-item <?= ($page == 'course_classes') ? 'active' : '' ?>"><a class="nav-link"
            href="index.php?page=course_classes"><i class="fas fa-fw fa-chalkboard"></i><span>Lớp học phần</span></a>
    </li>
    ...
    <li class="nav-item <?= ($page == 'students') ? 'active' : '' ?>"><a class="nav-link"
            href="index.php?page=students"><i class="fas fa-user-graduate"></i><span>Sinh viên</span></a></li>
    <li class="nav-item <?= ($page == 'rooms') ? 'active' : '' ?>"><a class="nav-link" href="index.php?page=rooms"><i
                class="fas fa-user-home"></i><span>Phòng học</span></a></li>
